...
secrets.forEach(secret => {
  ...
  console.log(
    `gh secret set ${secret.name} --body "YOUR_${secret.name}_VALUE"`
  );
  console.log('');
});
...
console.log('---------------');
console.log(
  '• Supabase Project Settings: https://supabase.com/dashboard/project/YOUR_PROJECT/settings/api'
);
console.log('• HubSpot Developer Portal: https://developers.hubspot.com/');
console.log(
  '• Netlify Site Settings: https://app.netlify.com/sites/YOUR_SITE/settings/general'
);
console.log(
...
console.log(
  '✅ After setting up secrets, your CI/CD pipeline will be fully functional!'
);
