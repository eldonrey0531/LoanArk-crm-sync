...
test.describe('HubSpot Database Page', () => {
  ...
  test('should load HubSpot database page successfully', async ({ page }) => {
    await page.goto('/hubspot-database');

    // Check page title or heading
    await expect(page.locator('h1, h2').filter({ hasText: /database|contacts/i })).toBeVisible();
