        ...
        {manualPagination ? (
          <>
            <div className='text-sm text-gray-500' aria-live='polite'>
              Page {manualPagination.currentPage} of{' '}
              {manualPagination.totalPages} ({manualPagination.totalItems} total
              contacts)
            </div>
            <div className='flex items-center space-x-2'>
              ...
              <Button
                ...
                disabled={
                  manualPagination.currentPage >= manualPagination.totalPages
                }
          ...
          <>
            <div className='text-sm text-gray-500'>
              Showing {table.getRowModel().rows.length} of {contacts.length}{' '}
              contacts
            </div>
            <div className='flex items-center space-x-2'>
              <Button
