...
export default function EmailVerificationSyncPage() {
  ...
  const { data: hubspotContacts, isLoading: hubspotLoading, error: hubspotError } = useHubSpotContacts();
  const { syncContact, isLoading: syncLoading } = useHubSpotSync();
  const { data: emailVerificationRecords, isLoading: emailVerificationLoading, error: emailVerificationError } = useEmailVerificationRecords();
