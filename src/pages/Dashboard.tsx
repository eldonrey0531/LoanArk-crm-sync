...
export default function Dashboard() {
  ...
  const { data: clientDistribution, isLoading: clientDistLoading } =
    useClientDistribution();
  const { data: syncComparison, isLoading: syncCompLoading } =
    useSyncComparison();
      ...
      <div className='flex justify-between items-center'>
        <div>
          ...
          <p className='text-muted-foreground mt-1'>
            Real-time contact management and sync monitoring
          </p>
        </div>
        <div className='flex space-x-2'>
          ...
          >
            <Database
              className={`w-4 h-4 mr-2 ${hubSpotSync.isPending ? 'animate-spin' : ''}`}
            />
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              <span className='text-success'>{stats?.withEmail || 0}</span> with
              email addresses
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              <span className='text-warning'>{stats?.pendingCount || 0}</span>{' '}
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
        ...
        <Card className='lg:col-span-2'>
          <CardHeader>
            ...
            <p className='text-sm text-muted-foreground'>
              Latest sync operations and contact updates
            </p>
          </CardHeader>
          <CardContent>
            {activityLoading ? (
            ...
            {healthLoading ? (
              ...
              <>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  >
                    {systemHealth?.supabaseDb === 'connected'
                      ? 'Connected'
                      : 'Disconnected'}
                  </Badge>
                </div>
